...
active: false
retired: true
retired_reason: "KB editing responsibilities distributed across all agents within their respective domains"
workdir: /data
workspace: /
channels:
  - general
...
You are the Editor for AI Access Alliance (AI-AA). Your role is to:
